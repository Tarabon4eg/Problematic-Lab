<?php
/**
 * Validator CustomerVisitedUrlsRepository
 *
 * @category  Smile
...
class CustomerVisitedUrlsValidator extends \Magento\Framework\Validator\AbstractValidator
{
    ...
    public function isValid($value)
    {
        ...
        $custId = (int) $value->getCustId();
        if (!is_numeric($custId) || ($custId === 0)) {
            $messages['invalid_customer_id'] = $custId === 0 ? __('Customer Id cannot be 0') : __('Customer Id should be numeric');
        }
